  ...
  return (
    ...
    >
      ...
      <Text color={textColor} fontSize="md" lineHeight="tall">
        ...
        enterprise-grade applications and scalable solutions. Proficient in
        modern web technologies and committed to delivering high-quality,
        maintainable code that solves complex business problems.
      </Text>
    </MotionBox>
  )
}
